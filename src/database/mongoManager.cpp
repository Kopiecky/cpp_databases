...
bsoncxx::document::value MongoManager::createDocument(std::string timestamp, std::string name, int value)
{
...
void MongoManager::insertData(std::string timestamp, std::string name, int value)
{
    auto document = createDocument(timestamp, name, value);
